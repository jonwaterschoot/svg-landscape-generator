...
void setup() {
  ...
  cp5.addButton("exportSVG")
     ...
     .setPosition(cp5X, cp5YStart + cp5Spacing * 9)
...
void drawScene() {
  ...
  // Sky (placeholder)
  fill(200);
  rect(0, 0, canvasWidth, canvasHeight / 3);
...
public void exportSVG() {
  ...
  pg.fill(200);
  pg.rect(0, 0, canvasWidth, canvasHeight / 3);
  pg.stroke(255, 0, 0);
  pg.fill(255, 255, 255);
  pg.strokeWeight(2);
  pg.ellipseMode(CENTER);
  pg.ellipse(sunX, sunY, sunSize * 2, sunSize * 2);
  drawWater(pg); // Pass the graphics context
